...
describe 'requesting a login' do
  it 'works as expected' do
    ...
    expect(page).to have_text 'Request sent. You can log in once your request has been approved.'
  end
  ...
  it 'gives you a helpful message if you try to log in before being approved' do
    ...
    expect(page).to have_text "Your account must be approved by an administrator \ 
