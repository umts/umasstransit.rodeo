...
maneuvers['Diminishing Clearance'] = FactoryBot.create :maneuver,
                                                         name: 'Diminishing Clearance',
                                                         speed_target: 20
maneuvers['Judgement Stop'] = FactoryBot.create :maneuver,
                                                  name: 'Judgement Stop',
                                                  counts_additional_stops: true

# Serpentine
([10] * 14 << 25).each do |obst_point|
  FactoryBot.create :obstacle, point_value: obst_point, obstacle_type: 'cone',
...
([20, 16, 8, 4, 2] * 2).each do |obst_point|
  FactoryBot.create :obstacle, point_value: obst_point, obstacle_type: 'ball',
...
FactoryBot.create :distance_target, intervals: 5, multiplier: 5, minimum: 0,
...
([25] * 5).each do |obst_point|
  FactoryBot.create :obstacle, point_value: obst_point, obstacle_type: 'curb',
    maneuver: maneuvers['First Passenger Stop']
end

FactoryBot.create :distance_target, intervals: 0, multiplier: 1, minimum: 6,
  maneuver: maneuvers['First Passenger Stop'], name: 'front tire to curb'

FactoryBot.create :distance_target, intervals: 0, multiplier: 1, minimum: 15,
...
([20, 16, 8, 4, 2] * 2).each do |obst_point|
  FactoryBot.create :obstacle, point_value: obst_point, obstacle_type: 'barrel',
    maneuver: maneuvers['Diminishing Clearance']
end

# Judgement stop
FactoryBot.create :obstacle, point_value: 50, obstacle_type: '18" marker',
